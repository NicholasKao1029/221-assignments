...
namespace filler
{
        bool inRange(int x, int y, point p, int l);
        bool insideImg(int x, int y, int h, int w);
        void changeColor(int x, int y, PNG& img, point p, colorPicker& fillColor);
        bool checkProcessed(int x, int y, vector<vector<bool>>& PC);
        bool processPoint(int x, int y, int h, int w, int l, PNG& imgDum, OrderingStructure<point> &OS, point p, colorPicker& fillColor, vector<vector<bool>>& PC);
        // animation vorCustomBFS(PNG& img, double density, int hMin, int hMax, int frameFreq);
        // animation vorCustomDFS(PNG& img, double density, int hMin, int hMax, int frameFreq);
